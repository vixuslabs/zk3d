...
describe('Vector3 operations', () => {
  ...
  test('vector addition', () => {
    ...
    const threejsResultArray = [threejsResult.x, threejsResult.y, threejsResult.z].map(x => round(x, 4));
    const zk3dResult = v1z.clone().add(v2z);
    const zk3dResultArray = [zk3dResult.x.toNumber(), zk3dResult.y.toNumber(), zk3dResult.z.toNumber()].map(x => round(x, 4));
  ...
  test('vector multiplication', () => {
    ...
    const threejsResultArray = [threejsResult.x, threejsResult.y, threejsResult.z].map(x => round(x, 2));
    const zk3dResult = v1z.clone().multiply(v2z);
    const zk3dResultArray = [zk3dResult.x.toNumber(), zk3dResult.y.toNumber(), zk3dResult.z.toNumber()].map(x => round(x, 2));
    expect(threejsResultArray).toEqual(zk3dResultArray);
  });
  ...
  test('multiplication by scalar', () => {
    ...
    const threejsResultArray = [threejsResult.x, threejsResult.y, threejsResult.z].map(x => round(x, 3));
    const zk3dResult = v1z.clone().multiplyScalar(ZK3D.Real64.from(scalar));
    const zk3dResultArray = [zk3dResult.x.toNumber(), zk3dResult.y.toNumber(), zk3dResult.z.toNumber()].map(x => round(x, 3));
    expect(threejsResultArray).toEqual(zk3dResultArray);
  });
  ...
  test('divide', () => {
    ...
    const threejsResultArray = [threejsResult.x, threejsResult.y, threejsResult.z].map(x => round(x, 1));
    const zk3dResult = v1z.clone().divide(v2z);
    const zk3dResultArray = [zk3dResult.x.toNumber(), zk3dResult.y.toNumber(), zk3dResult.z.toNumber()].map(x => round(x, 1));
    expect(threejsResultArray).toEqual(zk3dResultArray);
  });
